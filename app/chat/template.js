...
export default function ChatTemplate({ children }) {
    return (
        <div className="grid h-screen text-sm md:text-base items-stretch w-full min-h-screen">
            <div className="flex flex-col w-full min-h-screen bg-gray-100 dark:bg-gray-800">
                <div className="grid h-screen w-full grid-cols-1 md:grid-cols-[300px_1fr]">
                    <div className="hidden bg-white md:flex flex-col border-r border-gray-100 dark:border-gray-800">
                        <div className="flex items-center h-16 px-4 border-b md:px-6">
                            <Disclosure as="nav" />
                            <Link className="flex items-center gap-2 text-lg font-semibold" href="#">
                                <img className="w-8 h-8 rounded-full object-cover" src="/deltasoft-logo.png" alt="" />
                        ...
                        <nav className="flex-1 overflow-y-auto py-4">
                            <div className="grid gap-4 px-4">
                                ...
                                <Link className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium" href="#">
                    ...
                    <div className="flex flex-col w-full min-h-screen">
                        <header className="flex items-center h-16 px-4 md:px-6">
                            <div className="flex items-center ml-auto gap-2 md:gap-4 lg:gap-6">
                                <Disclosure as="nav">
                                    <div className="hidden md:block">
                                        <div className="ml-4 flex items-center md:ml-6">
                                            <button
                                                type="button"
                                                className="relative rounded-full p-1 text-neutral-600 hover:text-neutral-500"
                                            >
                                            ...
                                            <Menu as="div" className="relative ml-3">
                                                <div>
                                                    <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-neutral-800 text-sm ring-1 ring-neutral-800/50">
                                                        <span className="absolute -inset-1.5" />
