...
export default function ChatInput({ conversation, setConversation }) {
    ...
    return (
        <div className="bg-white border border-gray-300 shadow-md rounded-2xl w-full max-w-4xl p-4 mx-auto flex flex-row gap-4 items-center">
            ...
            <input onChange={handleSearchChange} value={content} className="overflow-y-scroll outline-none resize-none border-none w-full text-neutral-700 font-medium text-base leading-6" placeholder="Chat with Delta..." />
